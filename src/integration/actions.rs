...
use super::targets::{
    ...
    install_kiro, install_mastracode, install_omp, install_opencode, install_pi, install_qodercli,
    ...
    uninstall_kilo, uninstall_kimi, uninstall_kiro, uninstall_mastracode, uninstall_omp,
